...
const HomeNavBar = () => {
  ...
  const handleDateChange = (dates) => {
    ...
    setStartDate(start);
    setEndDate(end);
    setShowDatePicker(true); // Hide date picker after selecting range
  };
    ...
    <div className="flex space-x-4 bg-white rounded-s-lg rounded-e-lg w-fit">
      <div className="flex ">
        <div className="border-1  border-r-0 border-black p-2 rounded-s-lg first:border-r-2 w-[300px]">
          ...
          <div className="text-sm text-gray-500 col-span-2 mb-2 font-poppins h-6 flex pt-2">Location</div>
          <Dropdown
            options={locations}
        ...
        <div
          className="border-1 border-black p-2 first:border-l-2 flex items-center"
        ...
        >
          ...
          <div className="row-span-2 items-center justify-center flex pt-2 w-10" >
            <span  >
            <IoIosClock size={"45px"} color="#ef499b"/> </span>     
          </div>
        <div className="text-sm text-gray-500 col-span-2 mb-2 font-poppins h-6 flex pt-2">From - To</div>
